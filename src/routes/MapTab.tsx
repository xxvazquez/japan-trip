...
function PlaceRow({
  ...
  const rowCls = "flex items-center gap-3 px-3.5 py-3 text-[1.0625rem]";
        ...
        <>
          ...
          {(!readOnly || place.note?.trim()) && (
            <li className={`${INSET_DIVIDER} px-3.5 py-3`}>
              <RichNote value={place.note ?? ""} onCommit={onNote} placeholder="Add a note" className="text-[0.9375rem] leading-snug text-ink-soft" />
            </li>
          )}
