            ...
            {j.gmapsDirections && (
              <li className={INSET_DIVIDER}>
                <a href={j.gmapsDirections} target="_blank" rel="noopener" className="flex items-center justify-between gap-3 px-3.5 py-3">
                  <span className="flex items-center gap-2 text-[1.0625rem] text-accent">
                        ...
                        <div className="flex">
                          {stripCells.map((c, ci) => (
                            ...
                            >
                              ...
                              <div className="value mt-0.5 text-[1.0625rem] leading-tight [overflow-wrap:anywhere]">{c.value}</div>
                            </div>
                          ))}
                        </div>
                      </div>
