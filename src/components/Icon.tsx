...
const P: Record<IconName, JSX.Element> = {
  ...
  settings: (
    <>
      ...
      <path d="M19.4 12a7.5 7.5 0 0 0-.1-1.2l2-1.55-2-3.46-2.36.95a7.4 7.4 0 0 0-2.07-1.2L14.5 2h-4l-.37 2.54a7.4 7.4 0 0 0-2.07 1.2L5.7 4.79l-2 3.46 2 1.55a7.5 7.5 0 0 0 0 2.4l-2 1.55 2 3.46 2.36-.95c.62.5 1.32.9 2.07 1.2L10.5 22h4l.37-2.54a7.4 7.4 0 0 0 2.07-1.2l2.36.95 2-3.46-2-1.55c.07-.4.1-.8.1-1.2Z" />
    </>
  ),
  archive: (
    <>
