 ...
 * with a prominent header sitting on a rule directly above its content. Used for
  ...
  return (
    ...
    >
      <div className="mb-3 flex items-baseline justify-between gap-3 border-b border-line pb-2.5">
        <h2 className="font-sans text-sm font-semibold uppercase tracking-[0.09em] text-ink">{title}</h2>
