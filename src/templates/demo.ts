...
export function buildDemo(): TripData {
  const data: TripData = {
    ...
    places: [
      ...
      { id: "pl-2", name: "A museum", lat: 35.7188, lng: 139.7765, category: "see", color: "#5c6bc0" },
      { id: "pl-3", name: "A viewpoint", lat: 35.7120, lng: 139.7710, category: "see", color: "#5c6bc0" },
      { id: "pl-4", name: "Market for lunch", lat: 35.7106, lng: 139.7743, category: "food", color: "#26a69a" },
