 ...
 * no preset shares another's grey. "Ink & Moss" (index 0) is the muted house
 * default — a cool-grey ramp with a soft indigo accent. The other five each
...
export const THEME_PRESETS: ThemePreset[] = [
  {
    ...
    tokens: {
      light: {
        ...
        accent: "#5e718a", gold: GOLD.light, matcha: MATCHA.light, ai: AI.light, danger: DANGER.light,
      },
      dark: {
        bg: "#13171b", surface: "#22282d", "surface-2": "#2d343b",
        ink: "#e5e9ec", "ink-soft": "#b1bbc2", "ink-faint": "#878f98", line: "#2d353c",
        accent: "#8095af", gold: GOLD.dark, matcha: MATCHA.dark, ai: AI.dark, danger: DANGER.dark,
      },
    },
  },
  {
    id: "slate",
    name: "Slate",
    hint: "Muted steel blue on a cool grey cast",
    tokens: {
      light: {
        bg: "#eef1f4", surface: "#f9fbfc", "surface-2": "#e1e6ea",
        ink: "#1a2027", "ink-soft": "#47525b", "ink-faint": "#6d7982", line: "#c4ccd2",
        accent: "#3f6e8c", gold: GOLD.light, matcha: MATCHA.light, ai: AI.light, danger: DANGER.light,
      },
      dark: {
        bg: "#0d1114", surface: "#1a2027", "surface-2": "#242c34",
        ink: "#eef2f5", "ink-soft": "#aab5bd", "ink-faint": "#7e8991", line: "#2c353d",
        accent: "#7fa8c4", gold: GOLD.dark, matcha: MATCHA.dark, ai: AI.dark, danger: DANGER.dark,
      },
    },
  },
  {
    id: "teal",
    name: "Teal",
    hint: "Muted teal on a green-grey cast",
    tokens: {
      light: {
        bg: "#edf2f1", surface: "#f8fbfa", "surface-2": "#dfe8e6",
        ink: "#182320", "ink-soft": "#46534f", "ink-faint": "#6c7975", line: "#c3cfcc",
        accent: "#3f7a7a", gold: GOLD.light, matcha: MATCHA.light, ai: AI.light, danger: DANGER.light,
      },
      dark: {
        bg: "#0c1211", surface: "#19211f", "surface-2": "#232c29",
        ink: "#ecf2f0", "ink-soft": "#a8b6b2", "ink-faint": "#7c8985", line: "#2b3532",
        accent: "#7cb0b0", gold: GOLD.dark, matcha: MATCHA.dark, ai: AI.dark, danger: DANGER.dark,
      },
    },
  },
  {
    id: "plum",
    name: "Plum",
    hint: "Muted violet on a mauve-grey cast",
    tokens: {
      light: {
        bg: "#f1eef4", surface: "#faf8fb", "surface-2": "#e4dfe9",
        ink: "#211d26", "ink-soft": "#4e4757", "ink-faint": "#786f83", line: "#cec6d4",
        accent: "#6f4f82", gold: GOLD.light, matcha: MATCHA.light, ai: AI.light, danger: DANGER.light,
      },
      dark: {
        bg: "#100d15", surface: "#1e1a24", "surface-2": "#29232f",
        ink: "#efecf2", "ink-soft": "#b3a9bf", "ink-faint": "#857a90", line: "#322b3a",
        accent: "#a685bd", gold: GOLD.dark, matcha: MATCHA.dark, ai: AI.dark, danger: DANGER.dark,
      },
    },
  },
  {
    id: "sage",
    name: "Sage",
    hint: "Muted green on a soft green-grey cast",
    tokens: {
      light: {
        bg: "#eef2ec", surface: "#f9fbf7", "surface-2": "#dfe6da",
        ink: "#1c2318", "ink-soft": "#495141", "ink-faint": "#707963", line: "#c8d0c0",
        accent: "#52734a", gold: GOLD.light, matcha: MATCHA.light, ai: AI.light, danger: DANGER.light,
      },
      dark: {
        bg: "#0e130b", surface: "#1b2117", "surface-2": "#252c20",
        ink: "#ecf1e7", "ink-soft": "#a9b49f", "ink-faint": "#7c8672", line: "#2d352a",
        accent: "#86a97e", gold: GOLD.dark, matcha: MATCHA.dark, ai: AI.dark, danger: DANGER.dark,
      },
    },
  },
  {
    id: "clay",
    name: "Clay",
    hint: "Muted rose on a warm grey cast",
    tokens: {
      light: {
        bg: "#f4eeed", surface: "#fbf7f6", "surface-2": "#e8dcda",
        ink: "#251c1a", "ink-soft": "#574a47", "ink-faint": "#837371", line: "#dac9c6",
        accent: "#a15347", gold: GOLD.light, matcha: MATCHA.light, ai: AI.light, danger: DANGER.light,
      },
      dark: {
        bg: "#150f0e", surface: "#241c1a", "surface-2": "#2f2624",
        ink: "#f1e6e3", "ink-soft": "#bda9a5", "ink-faint": "#8f7d7a", line: "#38302c",
        accent: "#cf8577", gold: GOLD.dark, matcha: MATCHA.dark, ai: AI.dark, danger: DANGER.dark,
      },
    },
  },
];
