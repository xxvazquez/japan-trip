...
const OWNER_EMAIL = process.env.OWNER_EMAIL ?? "lauramaestuv@gmail.com";
...
out.push(`  insert into trips (id, user_id, name, subtitle, template_id, position, config, meta, media, scratch)`);
out.push(`  values (`);
